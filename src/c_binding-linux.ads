...
--     for Unsigned_32'Size use 32;
   ...
   function Read (File : Linux.File; Bytes : in out Stream_Element_Array) return SSize_Type with
     Global => null,
     Pre    => File.Is_Open;
   ...
   type Epoll_Event_Array is
     array (Positive range 1 .. 64) of aliased Epoll_Event;
   ...
   procedure Close (File_Descriptor : Interfaces.C.int) with
     Import        => True,
     Convention    => C,
     External_Name => "close";
