...
function Registry_Bind (Registry : Registry_Ptr;
   ...
   New_Id : Interfaces.Unsigned_32) return Proxy_Ptr is
begin
...
function Data_Device_Manager_Get_Version (Data_Device_Manager : Data_Device_Manager_Ptr) return Interfaces.Unsigned_32 is
begin
