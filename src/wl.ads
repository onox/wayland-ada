...
--       Convention => C_Pass_By_Copy;
   ...
   function Display_Dispatch (Display : Display_T) return Interfaces.C.int;

   procedure Display_Dispatch (Display : Display_T);

   function Display_Roundtrip (Display : Display_T) return Interfaces.C.int;

   procedure Display_Roundtrip (Display : Display_T);
