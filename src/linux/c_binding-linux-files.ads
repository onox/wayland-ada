...
package C_Binding.Linux.Files is
   ...
   function Close (This : in out File) return Success_Flag
     with Global => null,
          Pre    => Is_Open (This),
          Post   => Is_Closed (This);
   ...
   function File_Descriptor (This : File) return Integer
     with Global => null,
          Pre    => Is_Open (This);
   ...
   function Is_Closed (This : File) return Boolean
     with Global => null;
...
private
   ...
   function C_Open
     (File_Name : C_String;
      Flags     : O_FLag;
      S_Flags   : S_FLag) return Interfaces.C.int
