...
private package C_Binding.Wl_Thin is
   ...
   function Display_Get_File_Descriptor (Display : Display_Ptr) return Integer with
      Pre           => Display /= null,
      Convention    => C,
      Import        => True,
   ...
   function Proxy_Marshal_Constructor
     (Proxy       : Proxy_Ptr;
      ...
      Height      : Integer;
      Stride      : Integer;
      Format      : Unsigned_32) return Proxy_Ptr with
      Convention    => C,
      Import        => True,
      External_Name => "wl_proxy_marshal_constructor";
   ...
   procedure Proxy_Marshal (Proxy : Proxy_Ptr; Opcode : Unsigned_32) with
      Convention    => C,
      Import        => True,
   ...
   function Display_Dispatch_Pending (Display : Display_Ptr) return Integer with
      Import        => True,
      Convention    => C,
   ...
   procedure Proxy_Marshal (Proxy : Proxy_Ptr; Opcode : Unsigned_32; Arg_1 : C_String) with
      Convention    => C,
      Import        => True,
      External_Name => "wl_proxy_marshal";
