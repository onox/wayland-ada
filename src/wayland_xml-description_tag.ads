package Wayland_XML.Description_Tag is
   ...
   function Text (This : Description_Tag_T) return Aida.String_T with
     Global => null,
   ...
   function Summary (This : Description_Tag_T) return Aida.String_T with
     Global => null,
...
private
   ...
   function Text (This : Description_Tag_T) return Aida.String_T is (This.My_Text.Value.all);

   function Exists_Text (This : Description_Tag_T) return Boolean is (This.My_Text.Exists);

   function Summary (This : Description_Tag_T) return Aida.String_T is (This.My_Summary.Value.all);
