...
package C_Binding.Linux.Sockets is
   ...
   function Shutdown (This : in out General_Socket) return Success_Flag;
   ...
   type Read_Result (Id : Read_Result_Id) is record
      case Id is
         when Read_Failure | Read_End_Of_File => null;
         when Read_Success =>
