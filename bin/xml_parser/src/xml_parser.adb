...
procedure XML_Parser is
   ...
   procedure Create_Wayland_Spec_File (File_Name : String) is
      ...
      begin
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Compositor) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Seat) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Shm) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Shm_Pool) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Surface) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "     Global => null;");
         Put_Line (File, "");
         Put_Line (File, "   procedure Commit (Surface : Protocol.Surface) with");
         Put_Line (File, "     Global => null;");
         Put_Line (File, "");
         Put_Line (File, "   procedure Destroy (Surface : in out Protocol.Surface) with");
         Put_Line (File, "     Global => null,");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Buffer) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Display) return Boolean with");
         Put_Line (File, "     Global => null;");
         Put_Line (File, "");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Dispatch (Display : Protocol.Display) return Int with");
         Put_Line (File, "     Global => null,");
         Put_Line (File, "     Pre    => Display.Is_Connected;");
         Put_Line (File, "");
         Put_Line (File, "   procedure Dispatch (Display : Protocol.Display) with");
         Put_Line (File, "     Global => null,");
         Put_Line (File, "     Pre    => Display.Is_Connected;");
         Put_Line (File, "");
         Put_Line (File, "   function Roundtrip (Display : Protocol.Display) return Int with");
         Put_Line (File, "     Global => null,");
         Put_Line (File, "     Pre    => Display.Is_Connected;");
         Put_Line (File, "");
         Put_Line (File, "   procedure Roundtrip (Display : Protocol.Display) with");
         Put_Line (File, "     Global => null,");
         Put_Line (File, "     Pre    => Display.Is_Connected;");
         Put_Line (File, "");
         Put_Line (File, "   procedure Disconnect (Display : in out Protocol.Display) with");
         Put_Line (File, "     Global => null,");
         Put_Line (File, "     Pre    => Display.Is_Connected,");
         ...
         Put_Line (File, "");
         Put_Line (File, "   function Has_Proxy (Object : Registry) return Boolean");
         Put_Line (File, "     with Global => null;");
         Put_Line (File, "");
--         Put_Line (File, "   function Has_Started_Subscription (Registry : Protocol.Registry) return Boolean");
--         Put_Line (File, "     with Global => null;");
--         Put_Line (File, "");
         Put_Line (File, "   procedure Destroy (Registry : in out Protocol.Registry) with");
         Put_Line (File, "     Global => null,");
