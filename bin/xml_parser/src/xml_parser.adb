...
--            Put_Line (File, "     with Default_Initial_Condition => not Display.Is_Connected;");
            ...
            if Name = "Display" then
               ...
               Put_Line (File, "                            Region : in out Protocol.Region)");
               Put_Line (File, "     with Pre => Object.Has_Proxy;");
               Put_Line (File, "");
               ...
               Put_Line (File, "                         Source : Data_Source;");
               Put_Line (File, "                         Origin : Surface;");
               Put_Line (File, "                         Icon   : Surface;");
               Put_Line (File, "                         Serial : Unsigned_32)");
               ...
               Put_Line (File, "     with Pre => Object.Has_Proxy;");
               Put_Line (File, "");
               Put_Line (File, "   function Frame (Object : Surface) return Callback");
               Put_Line (File, "     with Pre => Object.Has_Proxy;");
               Put_Line (File, "");
               Put_Line (File, "   procedure Set_Opaque_Region (Object : Surface;");
               Put_Line (File, "                                Region : Protocol.Region)");
               Put_Line (File, "     with Pre => Object.Has_Proxy;");
               Put_Line (File, "");
   ...
   procedure Create_Wayland_Body_File (File_Name : String) is
      ...
      begin
         ...
         Put_Line (File, "   end Dispatch;");
         Put_Line (File, "");
         Put_Line (File, "   function Roundtrip (Object : Display) return Int is");
         Put_Line (File, "   begin");
