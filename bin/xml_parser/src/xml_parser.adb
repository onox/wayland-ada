      ...
      procedure Generate_Manually_Edited_Partial_Type_Declarations is
         ...
         begin
            ...
            if Name = "Display" then
               ...
               Put_Line (File, "         Display   : Protocol.Display;");
               ...
               Put_Line (File, "        (Data       : not null Data_Ptr;");
               Put_Line (File, "         Data_Offer : Protocol.Data_Offer;");
               Put_Line (File, "         Mime_Type  : String);");
               Put_Line (File, "");
               ...
               Put_Line (File, "        (Data        : not null Data_Ptr;");
               Put_Line (File, "         Data_Source : Protocol.Data_Source;");
               Put_Line (File, "         Mime_Type   : String);");
               Put_Line (File, "");
               ...
               Put_Line (File, "        (Data        : not null Data_Ptr;");
               Put_Line (File, "         Data_Device : Protocol.Data_Device;");
               Put_Line (File, "         Id          : Unsigned_32);");
               Put_Line (File, "");
               ...
               Put_Line (File, "        (Data     : not null Data_Ptr;");
               Put_Line (File, "         Keyboard : Protocol.Keyboard;");
               ...
               Put_Line (File, "        (Data    : not null Data_Ptr;");
               Put_Line (File, "         Touch   : Protocol.Touch;");
               Put_Line (File, "         Serial  : Unsigned_32;");
               Put_Line (File, "         Time    : Unsigned_32;");
               Put_Line (File, "         Surface : Protocol.Surface;");
            ...
            Put_Line (File, "         Data   : not null Data_Ptr) return Call_Result_Code;");
            Put_Line (File, "");
