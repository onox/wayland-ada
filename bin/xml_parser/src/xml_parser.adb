...
procedure XML_Parser is
   ...
   procedure Create_Wayland_Body_File (File_Name : String) is
      ...
      begin
         ...
         Put_Line (File, "         Constants.Data_Offer_Accept,");
         Put_Line (File, "         Serial,");
         ...
         Put_Line (File, "   procedure Receive (Object          : Data_Offer;");
         Put_Line (File, "                      Mime_Type       : String;");
         Put_Line (File, "                      File_Descriptor : Integer) is");
         Put_Line (File, "   begin");
         Put_Line (File, "      Thin.Data_Offer_Receive");
         Put_Line (File, "        (Object.Proxy, +Mime_Type, File_Descriptor);");
